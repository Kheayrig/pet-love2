...
if(isset($_POST['submit'])) {
    $sp = $_POST['species'];
    $c = $_POST['city'];
    if($sp === '2') {header("Location: walking1.php");exit();}
    if($sp === '3' && $c === '2') {header("Location: walking2.php");exit();}
    if($sp === '3' && $c === '3') {header("Location: walking3.php");exit();}
    if($sp === '3') {header("Location: walking.php");exit();}
